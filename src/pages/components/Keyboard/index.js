...
function Keyboard() {
    ...
    return (
        <div className="body">
            <ReactTooltip delayHide={2}></ReactTooltip>
                <div className="tag">
                    <Tag color="magenta">键盘数据热力图</Tag>
                </div>
                <div className="keyboard">
                    {/* 键盘第一行 14 */}
                    
                    <ul className="row">
                        <Tooltip title={"count: "+keyboarddata2["esc"]}><li className="key clay" id="esc">~</li></Tooltip>
                        <Tooltip title={"count: "+keyboarddata2["btn1"]}><li className="key clay" id="btn1" >1</li></Tooltip>
                        <li className="key clay" id="btn2" data-tip={"count: "+keyboarddata2["btn2"]} data-event="mouseover" data-event-off='click'>2</li>
                        ...
                        <Tooltip title={"count: "+keyboarddata2["del"]}><li className="key clay" id="del">Back</li></Tooltip>
                    </ul>
                    {/* <!-- 键盘第二行14  --> */}
                    <ul className="row">
